...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ("email", "registration_number", )
...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ('email', 'first_name', 'middle_name', 'last_name', 'phone_number', 'room_no', 'floor', 'block')}),
        ('Permissions', {'fields': ('admin', 'staff', 'is_active', 'groups', 'user_permissions')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'registration_number', 'password1', 'password2')}
        ),
    )
    search_fields = ('email',)
    ordering = ('email',)
